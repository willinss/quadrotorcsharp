...
#define __VECTORS_H     1
   ...
   // extern void uart3_isr(void);
    ...
    #define VECTOR_063      uart1_isr       // 0x0000_00FC 63    47     UART1            Single interrupt vector for UART status sources
    ...
    #define VECTOR_107      LPLD_GPIO_Isr   // 0x0000_01AC 107   91     Port control module Pin Detect (Port E)
