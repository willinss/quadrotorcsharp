...
{uint8 temp[5] = {0},i = 0;
 ...
 for(i=0; i<5; i++)
  { switch(temp[i])
        { case 0: uart_send1 (UART1, 0x30);continue;
          case 1: uart_send1 (UART1, 0x31);continue;
          case 2: uart_send1 (UART1, 0x32);continue;
          case 3: uart_send1 (UART1, 0x33);continue;
          case 4: uart_send1 (UART1, 0x34);continue;
          case 5: uart_send1 (UART1, 0x35);continue;
          case 6: uart_send1 (UART1, 0x36);continue;
          case 7: uart_send1 (UART1, 0x37);continue;
          case 8: uart_send1 (UART1, 0x38);continue;
          case 9: uart_send1 (UART1, 0x39);continue;
        }
  }
 //uart_send1 (UART1, '\r');
 //uart_send1 (UART1, '\n');
